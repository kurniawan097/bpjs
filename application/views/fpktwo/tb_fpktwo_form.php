                    ...
                    <div class='col-md-12'>
                        <form action="<?php echo $action; ?>" method="post">
                            <div class='box-body'>
                               ...
                               <div class='form-group'>
                                    <div class="row">
                                <div class='col-sm-3'><label>Nama Jejaring</label> <?php echo form_error('nama_jejaring') ?>
                                ...
                                <div class='col-sm-3'><label>No Rekening</label> <?php echo form_error('norek') ?>
                                    <input type="text" class="form-control" name="norek" id="norek" placeholder="No Rekening" value="<?php echo $norek; ?>" />
                                </div> 
                                <div class='col-sm-2'><label>No NPWP</label> <?php echo form_error('nonpwp') ?>
            ...
            <div class="span6">
                    ...
                    <table class="table table-condensed">
                       ...
                       <div class='box-footer'>
                                ...
                                <a href="<?php echo site_url('fpktwo') ?>" class="btn btn-default">Cancel</a>
                            </div>
                        </form>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
