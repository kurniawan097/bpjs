        ...
        <div class="col-md-4">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('assets/img/user.png'); ?>" alt="User profile picture">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>Nama Bidang </b> <a class="pull-right"><?php echo strtoupper($company) ;?></a>
                        </li>
                        <li class="list-group-item">
