...
<html>
    <head>
        <meta charset="UTF-8">
        <title>FPK BPJS Kesehatan</title>
        ...
        <div class="wrapper">
            ...
            <footer class="main-footer">
                <div class="pull-right hidden-xs">
                    <strong>Created By</strong>&nbsp&nbsp<i class='fa fa-instagram'></i>&nbsp<a href='https://www.instagram.com/kurniawan_097/'>Kurniawan</a>
                    
                </div>
                <strong>Copyright &copy 2018 <a href="https://bpjs-kesehatan.go.id">BPJS Kesehatan</a> - </strong> All rights reserved
            </footer>
