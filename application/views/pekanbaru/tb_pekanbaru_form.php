                    ...
                    <div class='col-md-5'>
                        <form action="<?php echo $action; ?>" method="post">
                            <div class='box-body'>
                                ...
                                <div class='form-group'>Alamat <?php echo form_error('nama_faskes') ?>
                                    <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat" value="<?php echo $alamat; ?>" />
                                </div>                               
                                
                            </div>
                            <div class='box-footer'>
                                <input type="hidden" name="id_daerah" value="<?php echo $id_daerah='1'; ?>" /> 
                                <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
                                <a href="<?php echo site_url('pekanbaru') ?>" class="btn btn-default">Cancel</a>
                            </div>
                        </form>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
