                    ...
                    <div class='col-md-5'>
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <div class='box-footer'>
                                <input type="hidden" name="pel" value="<?php echo $pel='RITP'; ?>" />
                                <input type="hidden" name="id_pelayanan" value="<?php echo $id_pelayanan='1'; ?>" /> 
                                <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
                                <a href="<?php echo site_url('ritp') ?>" class="btn btn-default">Cancel</a>
                            </div>
                        </form>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
